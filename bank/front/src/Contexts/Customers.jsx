...
export const CustomersProvider = ({ children }) => {
    ...
    const { storeCustomer, setStoreCustomer, updateCustomer, setUpdateCustomer, destroyCustomer, setDestroyCustomer } = useCustomers(dispatchCustomers, editCustomer); // <-- useCustomers yra hookas, kuris valdo klientu duomenis ir kreipiasi i serveri
    return (
